...
<html>
	...
	-->
		...
		<script src="../js/symb/collections.traitsearch.js?ver=8" type="text/javascript"></script>
		...
		<div class="w3-row">
			...
			<div class="w3-col m10">
				...
				<div class="w3-card w3-round">
					<div class="w3-white">
					<!-- Taxon -->
						<button type="button" onclick="myFunction('taxon-criteria')" class="w3-button w3-block w3-theme-l1 w3-left-align"><?php echo $LANG['TAXON_HEADER']; ?></button>
						<div id="taxon-criteria" class="w3-hide w3-container">
							<div style="margin:10px 0px 0px 5px;">
								<input type='checkbox' name='usethes' value='1' CHECKED /><?php echo $LANG['INCLUDE_SYNONYMS']; ?>
							</div>
							<div>
					...
					<!-- Locality -->
						<button type="button" onclick="myFunction('location-criteria')" class="w3-button w3-block w3-theme-l1 w3-left-align"><?php echo $LANG['LOCALITY_CRITERIA']; ?></button>
						<div id="location-criteria" class="w3-hide w3-container">
							<div>
							...
							<hr>
							<div><?php echo $LANG['LAT_LNG_HEADER']; ?></div>
							<div>
						...
						</div> <!-- End #location-criteria -->

					<!-- Collector -->
						<button type="button" onclick="myFunction('collector-criteria')" class="w3-button w3-block w3-theme-l1 w3-left-align"><?php echo $LANG['COLLECTOR_HEADER']; ?></button>
						<div id="collector-criteria" class="w3-hide w3-container">
							<div>
					...
					<!-- Traits -->
						<?php
							if(isset($SEARCH_BY_TRAITS) && $SEARCH_BY_TRAITS) {
								...
								if($traitArr){
						?>
									<button type="button" onclick="myFunction('trait-criteria')" class="w3-button w3-block w3-theme-l1 w3-left-align"><?php echo $LANG['SPECIMEN_HEADER']; ?></button>
									<input type="hidden" id="SearchByTraits" value="true">
									<div id="trait-criteria" class="w3-hide w3-container">
						<?php
					...
					<!-- Specimen -->
						<button type="button" onclick="myFunction('other-criteria')" class="w3-button w3-block w3-theme-l1 w3-left-align"><?php echo $LANG['SPECIMEN_HEADER']; ?></button>
						<div id="other-criteria" class="w3-hide w3-container">
							<div>
		...
		<!-- Right Column -->
			<div class="w3-col m2">
					<div class="w3-row-padding">
							<div><button type="submit" style="width:100%" onclick="event.stopPropagation()"><?php echo isset($LANG['BUTTON_NEXT_LIST'])?$LANG['BUTTON_NEXT_LIST']:'List Display'; ?></button></div>
